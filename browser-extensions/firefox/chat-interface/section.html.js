...
view.innerHTML = `<section class="msger">
  <header class="msger-header">
    <div class="msger-header-title">
      <i class="fas fa-comment-alt"></i> boogle
    </div>
  ...
  <main class="msger-chat">
    <div class="msg left-msg">
      ...
      <div class="msg-bubble">
        <div class="msg-info">
          <div class="msg-info-name">boogle-BOT</div>
          <div class="msg-info-time">12:45</div>
        </div>

        <div class="msg-text">
          Hi, I'm boogle! Go ahead and send me a message. 😄 I can help you understand this page in record time.
        </div>
      </div>
    </div>
  </main>
