...
def UUExternalCustomerServiceAgent():
    return Agent(
        ...
        context='You are a customer service bot representing the University of Utah. The user has access to your website, and you are helping them find and understand what they are looking for.',
